...
class CheckActiveOfferersTest:
    ...
    def test_check_active_offerers(self, mock_get_siren, run_command):
        ...
        with time_machine.travel("2024-12-24 23:00:00"):
            run_command("check_active_offerers", raise_on_error=True)
...
class SynchronizeVenuesBannerWithGooglePlacesTest:
    ...
    def test_does_not_execute_and_log_after_28th(self, day, caplog, run_command):
        with time_machine.travel(f"2024-12-{day:02d} 23:00:00"):
            with caplog.at_level(logging.INFO):
                run_command("synchronize_venues_banners_with_google_places")
