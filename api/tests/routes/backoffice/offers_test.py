...
from pcapi.routes.backoffice.filters import format_date, format_titelive_id_lectorat
...
class ListOffersTest(GetEndpointHelper):
    ...
    def test_list_offers_with_different_stock_beginning_datetimes(self, authenticated_client):
