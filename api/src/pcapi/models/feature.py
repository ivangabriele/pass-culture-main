...
class FeatureToggle(enum.Enum):
    ...
    WIP_HACKATON_CATEGOTOMATIQUE_AUTOMATICALLY_ASSIGN_OFFER_CATEGORY = "Assigne automatiquement une catégorie et une sous catégorie à une offre à partir de son titre et sa description grace à l'IA"
    WIP_HACKATON_CATEGOTOMATIQUE_USE_CHATGPT = "Utiliser chatgpt pour la prédiction de l'offre"
    WIP_HACKATON_CATEGOTOMATIQUE_USE_GEMINI = "Utiliser gemini pour la prédiction de l'offre"
...
FEATURES_DISABLED_BY_DEFAULT: tuple[FeatureToggle, ...] = (
    ...
    FeatureToggle.WIP_HACKATON_CATEGOTOMATIQUE_AUTOMATICALLY_ASSIGN_OFFER_CATEGORY,
    FeatureToggle.WIP_HACKATON_CATEGOTOMATIQUE_USE_CHATGPT,
    FeatureToggle.WIP_HACKATON_CATEGOTOMATIQUE_USE_GEMINI,
