...
---`,displayName:"ListIconButton",props:{icon:{defaultValue:null,description:"The icon to display inside the button.",name:"icon",required:!0,type:{name:"string"}},className:{defaultValue:null,description:"Custom CSS class for additional styling of the button.",name:"className",required:!1,type:{name:"string"}},onClick:{defaultValue:null,description:"Callback function triggered when the button is clicked.",name:"onClick",required:!1,type:{name:"((event: MouseEvent<Element, MouseEvent>) => void)"}},variant:{defaultValue:{value:"ListIconButtonVariant.DEFAULT"},description:"The variant of the button.",name:"variant",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"primary"'}]}},tooltipContent:{defaultValue:null,description:"",name:"tooltipContent",required:!1,type:{name:"ReactNode"}},url:{defaultValue:null,description:"The URL to navigate to when the button is clicked.",name:"url",required:!1,type:{name:"string"}},isExternal:{defaultValue:{value:"true"},description:"Indicates if the link is external.",name:"isExternal",required:!1,type:{name:"boolean"}},dataTestid:{defaultValue:null,description:"Custom test ID for targeting the component in tests.",name:"dataTestid",required:!1,type:{name:"string"}},target:{defaultValue:null,description:"Target attribute for the <a> tag",name:"target",required:!1,type:{name:"string"}}}}}catch{}const $={title:"@/ui-kit/ListIconButton",component:i,decorators:[n=>t.jsx("div",{style:{margin:"50px",display:"flex"},children:t.jsx(n,{})})]},a={args:{icon:f,tooltipContent:t.jsx(t.Fragment,{children:"Duplicate"})}},r={args:{icon:f,tooltipContent:t.jsx(t.Fragment,{children:"Lire la FAQ"}),url:"http://wwww.test.com",onClick:()=>{},isExternal:!0}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    icon: fullTrashIcon,
