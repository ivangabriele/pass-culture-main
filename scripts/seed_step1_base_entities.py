#!/usr/bin/env python3
"""
Step 1: Generate base entities (users, deposits, offerers, addresses, offerer_addresses).
Saves IDs to state file for subsequent steps.
"""
...
class BaseEntityGenerator:
    ...
    def generate_users(self, count: int):
        ...
        logger.info(f"  ✓ Created {len(all_ids):,} users")
        return all_ids
    ...
    def generate_deposits(self, user_ids: list[int]):
        ...
        logger.info(f"  ✓ Created {len(all_ids):,} deposits")
        return all_ids
    ...
    def generate_offerers(self, count: int):
        ...
        logger.info(f"  ✓ Created {len(all_ids):,} offerers")
        return all_ids
    ...
    def generate_addresses(self, count: int):
        ...
        logger.info(f"  ✓ Created {len(all_ids):,} addresses")
        return all_ids

    def generate_offerer_addresses(self, offerer_ids: list[int], address_ids: list[int]):
        ...
        logger.info(f"  ✓ Created {len(all_ids):,} offerer_addresses")
        return all_ids
...
def main():
    ...
    parser.add_argument("--num-users", type=int, default=2000000)
    parser.add_argument("--num-offerers", type=int, default=100000)
